...
| **部署目标** | 本地 `pnpm tools-dev` · Vercel Web 层 · 打包好的 Electron 桌面端，支持 macOS（Apple Silicon）和 Windows（x64）—— 从 [open-design.ai](https://open-design.ai/) 或 [最新 release](https://github.com/agentik-os/AgentikDesign/releases) 直接下载 |
| **License** | Apache-2.0 |
...
- [x] `apps/packaged/` 出可分发 Electron 安装包 —— macOS（Apple Silicon）和 Windows（x64）下载已上线 [open-design.ai](https://open-design.ai/) 和 [GitHub releases 页面](https://github.com/agentik-os/AgentikDesign/releases)
...
<p align="center">
  <a href="https://github.com/agentik-os/AgentikDesign"><img src="docs/assets/star-us.png" alt="给 Open Design 点个 Star —— github.com/agentik-os/AgentikDesign" width="100%" /></a>
</p>

如果这套东西帮你省了半小时，给它一个 ★。Star 不付房租，但它告诉下一个设计师、Agent 和贡献者：这个实验值得他们的注意力。一次点击、三秒钟、真实信号：[github.com/agentik-os/AgentikDesign](https://github.com/agentik-os/AgentikDesign)。
