...
- Consume `@agentik-design/sidecar-proto`, `@agentik-design/sidecar`, and `@agentik-design/platform` primitives; do not hand-build stamp flags or process matching logic.
