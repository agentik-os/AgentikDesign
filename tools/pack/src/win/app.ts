...
import { createCommandInvocation, createPackageManagerInvocation } from "@agentik-design/platform";
...
async function buildWorkspaceArtifacts(config: ToolPackConfig): Promise<void> {
  ...
  try {
    await runPnpm(config, ["--filter", "@agentik-design/web", "build"], { OD_WEB_OUTPUT_MODE: config.webOutputMode });
