...
```bash
pnpm --filter @agentik-design/web build 2>&1 | tail -20 > /tmp/web-baseline-build.txt
```
...
```bash
pnpm --filter @agentik-design/contracts test critique.test.ts
```
...
```bash
pnpm --filter @agentik-design/contracts test sse.test.ts
```
...
```bash
pnpm --filter @agentik-design/contracts test
```
...
import type { PanelEvent } from '@agentik-design/contracts/critique';
...
```bash
pnpm --filter @agentik-design/daemon test parser.test.ts
```
...
import type { PanelEvent, PanelistRole } from '@agentik-design/contracts/critique';
...
import { describe, expect, it } from 'vitest';
import { defaultCritiqueConfig } from '@agentik-design/contracts/critique';
...
```bash
pnpm --filter @agentik-design/daemon test scoreboard.test.ts
```
...
import type { PanelistRole } from '@agentik-design/contracts/critique';
...
```ts
import type { CritiqueConfig, RoundDecision } from '@agentik-design/contracts/critique';
...
```ts
import type { FallbackPolicy } from '@agentik-design/contracts/critique';
...
```bash
pnpm --filter @agentik-design/daemon test migrations.test.ts
```
...
```bash
pnpm --filter @agentik-design/daemon test orchestrator.test.ts
```
...
} from '@agentik-design/contracts/critique';
import { panelEventToSse } from '@agentik-design/contracts/sse';
import { parseCritiqueStream } from './parser';
...
```ts
import { describe, expect, it } from 'vitest';
import { defaultCritiqueConfig, PROTOCOL_VERSION } from '@agentik-design/contracts/critique';
...
import { type CritiqueConfig, PROTOCOL_VERSION } from '@agentik-design/contracts/critique';
...
```bash
pnpm --filter @agentik-design/web test discovery.test.ts
```
...
import type { CritiqueSseEvent } from '@agentik-design/contracts/sse';
import type { PanelistRole } from '@agentik-design/contracts/critique';
