...
| **部署目標** | 本地 `pnpm tools-dev` · Vercel Web 層 · 打包好的 Electron 桌面端，支援 macOS（Apple Silicon）和 Windows（x64）—— 從 [open-design.ai](https://open-design.ai/) 或 [最新 release](https://github.com/agentik-os/AgentikDesign/releases) 直接下載 |
| **License** | Apache-2.0 |
...
- [x] `apps/packaged/` 出可分發 Electron 安裝包 —— macOS（Apple Silicon）和 Windows（x64）下載已上線 [open-design.ai](https://open-design.ai/) 和 [GitHub releases 頁面](https://github.com/agentik-os/AgentikDesign/releases)
...
<p align="center">
  <a href="https://github.com/agentik-os/AgentikDesign"><img src="docs/assets/star-us.png" alt="給 Open Design 點個 Star —— github.com/agentik-os/AgentikDesign" width="100%" /></a>
</p>

如果這套東西幫你省了半小時，給它一個 ★。Star 不付房租，但它告訴下一個設計師、Agent 和貢獻者：這個實驗值得他們的注意力。一次點選、三秒鐘、真實訊號：[github.com/agentik-os/AgentikDesign](https://github.com/agentik-os/AgentikDesign)。
...
<a href="https://github.com/agentik-os/AgentikDesign/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=agentik-os/AgentikDesign&cache_bust=2026-05-07" alt="Open Design 貢獻者" />
</a>

第一次提 PR？歡迎從 [`good-first-issue`/`help-wanted`](https://github.com/agentik-os/AgentikDesign/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22%2C%22help+wanted%22) 標籤起步。
